...
public class CartController {
    ...
    @GetMapping("/list")
    public R<List<CartDTO>> list(HttpSession session) {
    ...
    @PostMapping("/add")
    public R<Void> add(HttpSession session, @RequestParam Long productId,
    ...
    @PutMapping("/update")
    public R<Void> update(HttpSession session, @RequestParam Long cartId, @RequestParam int quantity) {
        Long userId = checkLogin(session);
    ...
    @PutMapping("/check/{id}")
    public R<Void> updateCheck(HttpSession session, @PathVariable Long id, @RequestParam int checked) {
        Long userId = checkLogin(session);
